...
class ReviewPage extends StatefulWidget {
  ...
  ReviewPage({this.route, this.price,this.seat});
  @override
                        ...
                        child: Column(
                          children: <Widget>[
                            ...
                            Row(
                              ...
                              children: <Widget>[
                                Text(
                                  "Jatis Trans - VIP Shuttle x ${widget.seat}",
                                  style: TextStyle(
                                    fontSize: 15,
                                    // color: Color(0xff8a8a8a),
                                  ),
                    ...
                    child: RaisedButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => PembayaranPage(route: widget.route,total_price:widget.price + hargaUnik,total_seat: widget.seat,)));
                      },
                    ),
                  )
                ],
